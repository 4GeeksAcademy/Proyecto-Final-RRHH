...
return (
  <section className="p-6">
      ...
      <div className="space-y-4">
        {tareas.map(tarea => (
          <div key={tarea.id} className="p-4 border rounded bg-white">
            ...
            <span className={`inline-block mt-2 px-2 py-1 rounded text-xs ${tarea.estado === "Finalizado"
    ...
    <div className={`mt-6 text-sm px-3 py-2 rounded ${USAR_API_REAL ? 'bg-green-100 text-green-800' : 'bg-orange-100 text-orange-800'}`}>
