...
export default function Dashboard() {
  ...
  return (
    ...
    <section className="p-6 min-h-screen bg-gray-50 bg-gray-900 transition-colors duration-300">
      <h1 className="text-3xl mb-4 font-bold text-gray-900 text-white">Panel de Control</h1>
      <p className="mb-6 text-gray-600 text-gray-400">Vista general de tu actividad</p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 w-full">
        ...
        <Cards to="/tareas"
          ...
          icon={<svg className="w-6 h-6 text-gray-800 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 21a9 9 0 1 1 0-18c1.052 0 2.062.18 3 .512M7 9.577l3.923 3.923 8.5-8.5M17 14v6m-3-3h6" /></svg>}
        ...
        <Cards to="/fichaje"
          ...
          icon={<svg className="w-6 h-6 text-gray-800 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8v4l3 3m6-3a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" /></svg>}
          total="Inactivo"
