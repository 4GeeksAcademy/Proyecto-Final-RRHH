...
export default function Fichaje() {
  ...
  return (
    ...
    <section className="p-4 md:p-8 bg-white transition-colors duration-300 min-h-screen">

      {/* Título de sección (opcional, si lo añades luego) */}
      <h2 className="text-2xl font-bold mb-6 text-gray-900">Registro de Actividad</h2>
