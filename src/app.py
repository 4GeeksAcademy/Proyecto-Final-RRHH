...
# @app.route('/email-prueba2', methods=['GET'])
# def email_prueba2():
...
def reset_password():
    ...
    if not email:
        return jsonify({"error": "Indica el correo electronico"}), 400
        ...
        <!DOCTYPE html>
            <html>
                <body style="font-family: Arial, sans-serif; color: #333;">
                    ...
                    <p>
                        <a href="{os.getenv('VITE_FRONTEND_URL')}/resetear?token={token}"
                        style="display: inline-block; padding: 10px 16px; background-color: #4f46e5;
                    ...
                    <p style="margin-top: 24px;">
                        — El equipo de TeamCore
                    </p>
                </body>
            </html>
        """
    msg = Message(
        subject="Resetea tu contraseña de TeamCore",
        sender="teamcore2026@gmail.com",
        recipients=[email],
        html=html_body
    )
